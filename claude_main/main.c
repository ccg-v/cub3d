...
void render_3d_view(t_data *data) {
    ...
    for (int x = 0; x < num_rays; x++) 
	{
        ...
        while (hit == 0) 
		{
			...
			// check if ray is out of bounds
            if (map_x < 0 || map_y < 0 || map_x >= (int)data->map.map_width || map_y >= (int)data->map.map_height)
				break;
...
int main() {
    ...
    data.map.north_texture = mlx_xpm_file_to_image(data.mlx, "/home/ccarrace/Desktop/cub3D_Claude/color_stone.xpm", &data.north_texture.width, &data.north_texture.height);
    ...
    data.map.south_texture = mlx_xpm_file_to_image(data.mlx, "/home/ccarrace/Desktop/cub3D_Claude/grey_stone.xpm", &data.south_texture.width, &data.south_texture.height);
    ...
    data.map.west_texture = mlx_xpm_file_to_image(data.mlx, "/home/ccarrace/Desktop/cub3D_Claude/purple_stone.xpm", &data.west_texture.width, &data.west_texture.height);
    ...
    data.map.east_texture = mlx_xpm_file_to_image(data.mlx, "/home/ccarrace/Desktop/cub3D_Claude/blue_stone.xpm", &data.east_texture.width, &data.east_texture.height);
